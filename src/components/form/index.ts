// export * from './CGUpload';
// export * from './CGSelect';
// export * from './CGCheckbox';

// export { default as CGCodes } from './CGCodes';
export { default as CGSwitch } from './CGSwitch';
// export { default as CGEditor } from './CGEditor';
